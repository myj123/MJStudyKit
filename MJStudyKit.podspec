#
# Be sure to run `pod lib lint MJStudyKit.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'MJStudyKit'
  s.version          = '0.1.0'
  s.summary          = 'A short description of MJStudyKit.'
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.source_files = 'MJStudyKit/Classes/**/*'
  
  # s.resource_bundles = {
  #   'MJStudyKit' => ['MJStudyKit/Assets/*.png']
  # }
